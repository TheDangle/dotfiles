...
exports.addAutoCompleteLaunchCmd = void 0;
...
const getFunctionCall = (lineNum, cursorPosition) => {
...
const addAutoCompleteLaunchCmd = (context) => {
    // context.subscriptions.push(lauchWiki);
    // context.subscriptions.push(lauchConsole);
};
exports.addAutoCompleteLaunchCmd = addAutoCompleteLaunchCmd;
//# sourceMappingURL=AutoCmpl.js.map