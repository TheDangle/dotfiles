...
exports.getTypeData = exports.getModuleData = exports.getSuggestions = void 0;
    ...
    if (currentWord == "") {
        ...
        if (line.includes("function love.")) {
            ...
            for (let i = 0; i < callbacks.length; i++) {
                ...
                newItem.detail = CONSTS_1.EXT_TAG;
...
function getModuleCompletionItems(modules) {
    ...
    for (let i = 0; i < modules.length; i++) {
        ...
        newItem.detail = "(module) " + CONSTS_1.EXT_TAG;
...
function getFunctionCompletionItems(functions) {
    ...
    for (let i = 0; i < functions.length; i++) {
        ...
        newItem.detail = "(function) " + CONSTS_1.EXT_TAG;
...
function getTypeCompletionItems(types) {
    ...
    for (let i = 0; i < types.length; i++) {
        ...
        newItem.detail = "(type) " + CONSTS_1.EXT_TAG;
...
function getEnumCompletionItems(enums) {
    ...
    for (let i = 0; i < enums.length; i++) {
        ...
        newItem.detail = "(enum) " + CONSTS_1.EXT_TAG;
...
function getEnumConstantCompletionTypes(enums) {
    ...
    for (let i = 0; i < enums.constants.length; i++) {
        ...
        newItem.detail = "(const) " + CONSTS_1.EXT_TAG;
