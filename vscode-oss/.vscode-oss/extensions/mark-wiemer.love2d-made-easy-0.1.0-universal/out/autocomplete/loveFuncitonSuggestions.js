...
exports.LoveSignatureHelpProvider = void 0;
    ...
    provideSignatureHelp(document, position, token) {
        ...
        if (fullMethodCall.split('.').length == 2) {
            ...
            if (moduleOrTypeName[0] === moduleOrTypeName[0].toUpperCase()) {
                ...
                let typeData = (0, loveAutocomplete_1.getTypeData)(luaApi_1.api.types, moduleOrTypeName);
                ...
                let moduleData = (0, loveAutocomplete_1.getModuleData)(moduleOrTypeName);
                let functionData = {};
                if (functionOrTypeName[0] === functionOrTypeName[0].toUpperCase()) {
                    // We're dealing with a function from a type of the module
                    let typeData = (0, loveAutocomplete_1.getTypeData)(moduleData.types, functionOrTypeName);
